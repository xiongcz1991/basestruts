package com.xiongcz.hibernate.one2one.dao;


import com.xiongcz.hibernate.one2one.entity.Student;
import com.xiongcz.hibernate.one2one.entity.StudentCard;
